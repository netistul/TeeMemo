...
export default function OptionsMenu(props) {
  ...
  async function restoreNotes() {
    ...
    try {
      ...
      if (
        !Array.isArray(restoredNotes) ||
        restoredNotes.length === 0 ||
        !restoredNotes[0].id ||
        !restoredNotes[0].content
      ) {
      ...
      alert(
        "Failed to restore notes. Please check the backup file and try again."
      );
    }
  }
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text
            style={{
              color: isStartupNote ? "#FFD700" : "#bab64d",
              marginLeft: 5,
              fontSize: 14,
            }}
          >
            ...
            <View style={{ flexDirection: "column" }}>
              ...
              >
                ...
                <Menu
                  ...
                  anchor={
                    <Button
                      onPress={() => setVisibleContrast(true)}
                      textColor="white"
                      mode="outlined"
                      style={{
                        borderColor: "white",
                ...
                >
                  <Menu.Item
                    style={{ backgroundColor: "#333" }}
                    titleStyle={{ color: "#d6d6d4" }}
                    onPress={() => {
                      setVisibleContrast(false);
                  ...
                  <Menu.Item
                    ...
                    onPress={() => {
                      setVisibleContrast(false);
                      setFontContrast({ color: "#ffffff", label: "High" });
                    }}
                    title="High"
                  />
                  <Menu.Item
                    ...
                    onPress={() => {
                      setVisibleContrast(false);
                      setFontContrast({ color: "#aaaaaa", label: "Medium" });
                    }}
                    title="Medium"
                  />
                  <Menu.Item
                    ...
                    onPress={() => {
                      setVisibleContrast(false);
                      setFontContrast({ color: "#555555", label: "Low" });
                    }}
                    title="Low"
                  />
                </Menu>
            ...
            >
              ...
              <Dialog.Content>
                <Text style={{ marginBottom: 10 }}>
                  You're about to create a backup of your notes. To save the
                  backup, simply choose a cloud service like Google Drive or
                  Dropbox from the sharing options that appear.
                </Text>
                ...
                >
                  ...
                  <Text style={{ flex: 1 }}>
                    from the sharing icons and save notes_backup.json there.
                  </Text>
                </View>
              </Dialog.Content>
            ...
            >
              ...
              <Dialog.Content>
                <Text style={{ flexWrap: "wrap", flexDirection: "row" }}>
                  To restore notes, you will need a backup file saved in JSON
                  format. While the default backup file is named:
                </Text>
                <View
                  style={{
                    flexDirection: "row",
                ...
                <Text>
                  you can select any compatible JSON file either from your
                  device's storage or directly from cloud services like Google
                  Drive.
                </Text>
              </Dialog.Content>
              <Dialog.Actions>
          ...
          >
            ...
            >
              <MaterialCommunityIcons
                ...
                color="#262626"
              />
              <Text style={{ color: "#9d9fd2", marginLeft: -1, fontSize: 17 }}>
                Backup Notes
              </Text>
            </TouchableOpacity>
